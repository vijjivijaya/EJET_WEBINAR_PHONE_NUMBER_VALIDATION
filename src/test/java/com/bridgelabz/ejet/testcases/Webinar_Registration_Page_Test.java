...
//On Intelij Terminal run command : allure serve allure-results
public class Webinar_Registration_Page_Test extends BaseClass {
    ...
    @Test
    @Description("Enter phone number starting with zero")
    ...
    @Test
    @Description("Enter phone no. starting with +91-")
    ...
    @Test
    @Description("Enter phone number starting with +91")
